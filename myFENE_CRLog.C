...
{
    defineTypeNameAndDebug(myFENE_CRLog, 0);
    addToRunTimeSelectionTable(constitutiveEq, myFENE_CRLog, dictionary);
}
}

// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::constitutiveEqs::myFENE_CRLog::myFENE_CRLog
(
    const word& name,
...
:
    ...
    (
        ...
        (
		 ...
		 U.mesh(),
		 dimensionedScalar("zero", dimless, 0.0) // Default value
	 ),
...
void Foam::constitutiveEqs::myFENE_CRLog::correct
(
